        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CardFile = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CardInfo_FileType_FileTypeId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", 0, "Dhaka,Dhanmondi", "42e5a45b-d6ce-4fe7-9224-777773c6d91b", 0L, new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), "admin@localhost.com", true, false, null, null, null, "Rajdip", "ADMIN@LOCALHOST.COM", "ADMIN@LOCALHOST.COM", "AQAAAAIAAYagAAAAEMYkylICFfzCpiKP+dM0MatdRR8ObaBglyORMQcKrxaxshdE61v1O4ZlvaESERbVtQ==", "01701734627", false, "4e1c3dfb-23c1-4435-adf8-5f6d2b22c8a9", false, "admin@localhost.com" },
                    { "2", 0, "Dhaka,Dhanmondi", "ca0d4184-74b1-4fcf-91a9-f7447f3dc2b8", 0L, new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), "employee@localhost.com", true, false, null, null, null, "Raja", "EMPLOYEE@LOCALHOST.COM", "EMPLOYEE@LOCALHOST.COM", "AQAAAAIAAYagAAAAEHcd773E4hfS+jv4eOgQ82Ljz93KDsS8+7/J4oCIIuf1LZZI79uW7bqi2h91wBganw==", "01701734627", false, "e1dec55b-c476-41ee-af22-fb6f8d8afd63", false, "employee@localhost.com" }
                });
